...
module mkBranch_Predictor(CLK,
  ...
  reg [63 : 0] _theResult_____1_fst__h9029;
  reg [1 : 0] _theResult_____1_snd__h8988, _theResult_____1_snd__h9030;
  ...
  wire [63 : 0] IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d308,
		...
		_theResult_____1_fst__h8864,
		_theResult_____1_fst__h8987,
		pred_pc___1__h3722,
		pred_pc__h2573,
		ret_pc___1__h4477,
		ret_pc__h4438;
  wire [1 : 0] _theResult_____1_snd_snd__h8866;
  ...
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd_snd__h8866)
  begin
    case (bp_train_cf_info[194:193])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd_snd__h8866;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_bp_train_in_ETC___d309 =
	     (IF_bp_train_is_i32_not_i16_THEN_bp_train_instr_ETC___d161 ||
	      IF_bp_train_is_i32_not_i16_THEN_bp_train_instr_ETC___d204) ?
	       (bp_train_is_i32_not_i16 ? ret_pc__h4438 : ret_pc___1__h4477) :
  ...
  assign _theResult_____1_fst__h8864 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_fst__h8987 :
	       _theResult_____1_fst__h9029 ;
  assign _theResult_____1_fst__h8987 =
	     (rf_btb_fsms$D_OUT_1 == 2'b0) ?
	       bp_train_cf_info[127:64] :
	       bp_train_cf_info[63:0] ;
  assign _theResult_____1_snd_snd__h8866 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_snd__h8988 :
	       _theResult_____1_snd__h9030 ;
  ...
  assign bp_train_instr_BITS_6_TO_0_18_EQ_0x5B_63_AND_b_ETC___d174 =
	     ...
	     (bp_train_instr[24:20] == 5'h0C ||
	      bp_train_instr[24:20] == 5'h14) ;
  assign pred_pc___1__h3722 = { btb_bramcore2$DOA[62:0], 1'b0 } ;
  assign pred_pc__h2573 =
  ...
  assign ret_pc___1__h4477 = bp_train_pc + 64'd2 ;
  assign ret_pc__h4438 = bp_train_pc + 64'd4 ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h9029 = bp_train_cf_info[127:64];
      2'd3: _theResult_____1_fst__h9029 = bp_train_cf_info[63:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h8988 = 2'b01;
      2'b01: _theResult_____1_snd__h8988 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h8988 = 2'b11;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h9030 = 2'b0;
      2'b10: _theResult_____1_snd__h9030 = 2'b01;
      2'b11: _theResult_____1_snd__h9030 = 2'b10;
    endcase
  end
