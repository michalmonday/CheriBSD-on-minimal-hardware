...
module mkCore_Synth(CLK,
  ...
  // inlined wires
  wire [576 : 0] dma_server_synth_wSynth_snk_putWire$wget;
  wire [98 : 0] dma_server_synth_arSynth_snk_putWire$wget,
		dma_server_synth_awSynth_snk_putWire$wget;
  ...
  wire core_mem_master_synth_arSynth_src_dropWire$whas,
       ...
       dma_server_synth_bSynth_src_dropWire$whas,
       dma_server_synth_rSynth_src_dropWire$whas;
  ...
  wire CAN_FIRE_RL_core_mem_master_synth_arSynth_src_doDrop,
       CAN_FIRE_RL_core_mem_master_synth_arSynth_src_setCanPeek,
       ...
       CAN_FIRE_RL_core_mem_master_synth_awSynth_src_setCanPeek,
       ...
       CAN_FIRE_RL_dma_server_synth_arSynth_snk_doPut,
       CAN_FIRE_RL_dma_server_synth_arSynth_snk_setCanPut,
       CAN_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut,
       CAN_FIRE_RL_dma_server_synth_awSynth_snk_doPut,
       CAN_FIRE_RL_dma_server_synth_awSynth_snk_setCanPut,
       CAN_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut,
       CAN_FIRE_RL_dma_server_synth_bSynth_src_doDrop,
       CAN_FIRE_RL_dma_server_synth_bSynth_src_setCanPeek,
       CAN_FIRE_RL_dma_server_synth_bSynth_src_setPeek,
       CAN_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop,
       CAN_FIRE_RL_dma_server_synth_rSynth_src_doDrop,
       CAN_FIRE_RL_dma_server_synth_rSynth_src_setCanPeek,
       CAN_FIRE_RL_dma_server_synth_rSynth_src_setPeek,
       CAN_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop,
       CAN_FIRE_RL_dma_server_synth_wSynth_snk_doPut,
       CAN_FIRE_RL_dma_server_synth_wSynth_snk_setCanPut,
       CAN_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut,
       ...
       WILL_FIRE_RL_core_mem_master_synth_arSynth_src_setCanPeek,
       ...
       WILL_FIRE_RL_core_mem_master_synth_awSynth_src_setCanPeek,
       ...
       WILL_FIRE_RL_dma_server_synth_arSynth_snk_doPut,
       WILL_FIRE_RL_dma_server_synth_arSynth_snk_setCanPut,
       WILL_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut,
       WILL_FIRE_RL_dma_server_synth_awSynth_snk_doPut,
       WILL_FIRE_RL_dma_server_synth_awSynth_snk_setCanPut,
       WILL_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut,
       WILL_FIRE_RL_dma_server_synth_bSynth_src_doDrop,
       WILL_FIRE_RL_dma_server_synth_bSynth_src_setCanPeek,
       WILL_FIRE_RL_dma_server_synth_bSynth_src_setPeek,
       WILL_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop,
       WILL_FIRE_RL_dma_server_synth_rSynth_src_doDrop,
       WILL_FIRE_RL_dma_server_synth_rSynth_src_setCanPeek,
       WILL_FIRE_RL_dma_server_synth_rSynth_src_setPeek,
       WILL_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop,
       WILL_FIRE_RL_dma_server_synth_wSynth_snk_doPut,
       WILL_FIRE_RL_dma_server_synth_wSynth_snk_setCanPut,
       WILL_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut,
  ...
  // rule RL_core_mem_master_synth_awSynth_src_setCanPeek
  assign CAN_FIRE_RL_core_mem_master_synth_awSynth_src_setCanPeek = 1'd1 ;
  assign WILL_FIRE_RL_core_mem_master_synth_awSynth_src_setCanPeek = 1'd1 ;
  ...
  // rule RL_core_mem_master_synth_wSynth_src_setCanPeek
  assign CAN_FIRE_RL_core_mem_master_synth_wSynth_src_setCanPeek = 1'd1 ;
  assign WILL_FIRE_RL_core_mem_master_synth_wSynth_src_setCanPeek = 1'd1 ;
  ...
  // rule RL_core_mem_master_synth_bSynth_snk_setCanPut
  assign CAN_FIRE_RL_core_mem_master_synth_bSynth_snk_setCanPut = 1'd1 ;
  assign WILL_FIRE_RL_core_mem_master_synth_bSynth_snk_setCanPut = 1'd1 ;
  ...
  // rule RL_core_mem_master_synth_arSynth_src_setCanPeek
  assign CAN_FIRE_RL_core_mem_master_synth_arSynth_src_setCanPeek = 1'd1 ;
  assign WILL_FIRE_RL_core_mem_master_synth_arSynth_src_setCanPeek = 1'd1 ;
  ...
  // rule RL_core_mem_master_synth_rSynth_snk_setCanPut
  assign CAN_FIRE_RL_core_mem_master_synth_rSynth_snk_setCanPut = 1'd1 ;
  assign WILL_FIRE_RL_core_mem_master_synth_rSynth_snk_setCanPut = 1'd1 ;
  ...
  // rule RL_dma_server_synth_awSynth_snk_setCanPut
  assign CAN_FIRE_RL_dma_server_synth_awSynth_snk_setCanPut = 1'd1 ;
  assign WILL_FIRE_RL_dma_server_synth_awSynth_snk_setCanPut = 1'd1 ;

  // rule RL_dma_server_synth_awSynth_snk_warnDoPut
  assign CAN_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_awSynth_snk_doPut &&
	     !core$dma_server_aw_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut ;

  // rule RL_dma_server_synth_awSynth_snk_doPut
  assign CAN_FIRE_RL_dma_server_synth_awSynth_snk_doPut =
	     dma_server_awvalid && core$dma_server_aw_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_awSynth_snk_doPut =
	     CAN_FIRE_RL_dma_server_synth_awSynth_snk_doPut ;

  // rule RL_dma_server_synth_wSynth_snk_setCanPut
  assign CAN_FIRE_RL_dma_server_synth_wSynth_snk_setCanPut = 1'd1 ;
  assign WILL_FIRE_RL_dma_server_synth_wSynth_snk_setCanPut = 1'd1 ;

  // rule RL_dma_server_synth_wSynth_snk_warnDoPut
  assign CAN_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_wSynth_snk_doPut &&
	     !core$dma_server_w_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut ;

  // rule RL_dma_server_synth_wSynth_snk_doPut
  assign CAN_FIRE_RL_dma_server_synth_wSynth_snk_doPut =
	     dma_server_wvalid && core$dma_server_w_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_wSynth_snk_doPut =
	     CAN_FIRE_RL_dma_server_synth_wSynth_snk_doPut ;

  // rule RL_dma_server_synth_bSynth_src_setCanPeek
  assign CAN_FIRE_RL_dma_server_synth_bSynth_src_setCanPeek = 1'd1 ;
  assign WILL_FIRE_RL_dma_server_synth_bSynth_src_setCanPeek = 1'd1 ;

  // rule RL_dma_server_synth_bSynth_src_setPeek
  assign CAN_FIRE_RL_dma_server_synth_bSynth_src_setPeek =
	     core$RDY_dma_server_b_peek ;
  assign WILL_FIRE_RL_dma_server_synth_bSynth_src_setPeek =
	     core$RDY_dma_server_b_peek ;

  // rule RL_dma_server_synth_bSynth_src_warnDoDrop
  assign CAN_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop =
	     dma_server_synth_bSynth_src_dropWire$whas &&
	     !core$dma_server_b_canPeek ;
  assign WILL_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop =
	     CAN_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop ;

  // rule RL_dma_server_synth_bSynth_src_doDrop
  assign CAN_FIRE_RL_dma_server_synth_bSynth_src_doDrop =
	     core$RDY_dma_server_b_drop &&
	     dma_server_synth_bSynth_src_dropWire$whas &&
	     core$dma_server_b_canPeek ;
  assign WILL_FIRE_RL_dma_server_synth_bSynth_src_doDrop =
	     CAN_FIRE_RL_dma_server_synth_bSynth_src_doDrop ;

  // rule RL_dma_server_synth_arSynth_snk_setCanPut
  assign CAN_FIRE_RL_dma_server_synth_arSynth_snk_setCanPut = 1'd1 ;
  assign WILL_FIRE_RL_dma_server_synth_arSynth_snk_setCanPut = 1'd1 ;

  // rule RL_dma_server_synth_arSynth_snk_warnDoPut
  assign CAN_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_arSynth_snk_doPut &&
	     !core$dma_server_ar_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut =
	     CAN_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut ;

  // rule RL_dma_server_synth_arSynth_snk_doPut
  assign CAN_FIRE_RL_dma_server_synth_arSynth_snk_doPut =
	     dma_server_arvalid && core$dma_server_ar_canPut ;
  assign WILL_FIRE_RL_dma_server_synth_arSynth_snk_doPut =
	     CAN_FIRE_RL_dma_server_synth_arSynth_snk_doPut ;

  // rule RL_dma_server_synth_rSynth_src_setCanPeek
  assign CAN_FIRE_RL_dma_server_synth_rSynth_src_setCanPeek = 1'd1 ;
  assign WILL_FIRE_RL_dma_server_synth_rSynth_src_setCanPeek = 1'd1 ;

  // rule RL_dma_server_synth_rSynth_src_setPeek
  assign CAN_FIRE_RL_dma_server_synth_rSynth_src_setPeek =
	     core$RDY_dma_server_r_peek ;
  assign WILL_FIRE_RL_dma_server_synth_rSynth_src_setPeek =
	     core$RDY_dma_server_r_peek ;

  // rule RL_dma_server_synth_rSynth_src_warnDoDrop
  assign CAN_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop =
	     dma_server_synth_rSynth_src_dropWire$whas &&
	     !core$dma_server_r_canPeek ;
  assign WILL_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop =
	     CAN_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop ;

  // rule RL_dma_server_synth_rSynth_src_doDrop
  assign CAN_FIRE_RL_dma_server_synth_rSynth_src_doDrop =
	     core$RDY_dma_server_r_drop &&
	     dma_server_synth_rSynth_src_dropWire$whas &&
	     core$dma_server_r_canPeek ;
  assign WILL_FIRE_RL_dma_server_synth_rSynth_src_doDrop =
	     CAN_FIRE_RL_dma_server_synth_rSynth_src_doDrop ;
  ...
  assign dma_server_synth_awSynth_snk_putWire$wget =
	     { dma_server_awid,
	       dma_server_awaddr,
	       dma_server_awlen,
	       dma_server_awsize,
	       ...
	       dma_server_awqos,
	       dma_server_awregion } ;
  assign dma_server_synth_wSynth_snk_putWire$wget =
	     { dma_server_wdata, dma_server_wstrb, dma_server_wlast } ;
  assign dma_server_synth_arSynth_snk_putWire$wget =
	     { dma_server_arid,
	       dma_server_araddr,
	       dma_server_arlen,
	       dma_server_arsize,
  ...
  assign dma_server_synth_bSynth_src_dropWire$whas =
	     core$dma_server_b_canPeek && dma_server_bready ;
  assign dma_server_synth_rSynth_src_dropWire$whas =
  ...
  assign core$dma_server_ar_put_val =
	     dma_server_synth_arSynth_snk_putWire$wget ;
  assign core$dma_server_aw_put_val =
	     dma_server_synth_awSynth_snk_putWire$wget ;
  assign core$dma_server_w_put_val =
	     dma_server_synth_wSynth_snk_putWire$wget ;
  ...
  begin
	...
	$display("WARNING: %m - putting into a Sink that can't be put into");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_server_synth_awSynth_snk_warnDoPut)
	$display("WARNING: %m - putting into a Sink that can't be put into");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_server_synth_wSynth_snk_warnDoPut)
	$display("WARNING: %m - putting into a Sink that can't be put into");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_server_synth_bSynth_src_warnDoDrop)
	$display("WARNING: %m - dropping from Source that can't be dropped from");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_server_synth_arSynth_snk_warnDoPut)
	$display("WARNING: %m - putting into a Sink that can't be put into");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_server_synth_rSynth_src_warnDoDrop)
	$display("WARNING: %m - dropping from Source that can't be dropped from");
  end
