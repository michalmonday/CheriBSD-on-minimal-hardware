...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [2 : 0] MUX_rg_abstractcs_cmderr$write_1__VAL_3,
  ...
  wire [63 : 0] req_data__h850;
  wire [31 : 0] virt_rg_abstractcs__h720, virt_rg_command__h766;
  wire [15 : 0] regno__h2725;
  wire [12 : 0] x__h1325, x__h1764;
  wire rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d38,
       rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d49,
       rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d61,
       rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d72,
       rg_abstractcs_cmderr_read__1_EQ_0_09_AND_write_ETC___d144,
       rg_abstractcs_cmderr_read__1_EQ_0_09_AND_write_ETC___d176,
       rg_command_access_reg_regno_read_ULE_0x101F___d36,
       rg_command_access_reg_regno_read_ULE_0x103F___d59,
       rg_command_access_reg_regno_read_ULE_0xFFF___d8,
       rg_command_access_reg_regno_read_ULT_0x1000___d34,
       rg_command_access_reg_regno_read_ULT_0x1020___d57,
       write_dm_addr_EQ_0x16_02_AND_rg_abstractcs_bus_ETC___d119,
       write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d151,
       write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d160,
       write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d169,
       write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d223;
  ...
  always@(av_read_dm_addr or
	  rg_data1 or
	  rg_data0 or virt_rg_abstractcs__h720 or virt_rg_command__h766)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h16: av_read = virt_rg_abstractcs__h720;
      7'h17: av_read = virt_rg_command__h766;
  ...
  FIFO2 #(.width(32'd77), .guarded(1'd1)) f_hart0_csr_reqs(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd65), .guarded(1'd1)) f_hart0_csr_rsps(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd70), .guarded(1'd1)) f_hart0_fpr_reqs(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd65), .guarded(1'd1)) f_hart0_fpr_rsps(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd70), .guarded(1'd1)) f_hart0_gpr_reqs(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd65), .guarded(1'd1)) f_hart0_gpr_rsps(.RST(RST_N),
							   .CLK(CLK),
  ...
  assign CAN_FIRE_RL_rl_gpr_write_start =
	     f_hart0_gpr_reqs$FULL_N &&
	     rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d38 ;
  ...
  assign MUX_rg_abstractcs_cmderr$write_1__SEL_5 =
	     EN_write &&
	     write_dm_addr_EQ_0x16_02_AND_rg_abstractcs_bus_ETC___d119 ;
  assign MUX_rg_data0$write_1__SEL_2 =
	     EN_write && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr == 7'h04 ;
  ...
  assign MUX_f_hart0_csr_reqs$enq_1__VAL_1 =
	     { 1'd1, rg_command_access_reg_regno[11:0], req_data__h850 } ;
  ...
  case (1'b1)
    ...
    EN_reset || WILL_FIRE_RL_rl_gpr_read_finish ||
    WILL_FIRE_RL_rl_gpr_write_finish ||
    WILL_FIRE_RL_rl_csr_read_finish ||
    WILL_FIRE_RL_rl_csr_write_finish:
	rg_abstractcs_busy$D_IN = 1'd0;
    default: rg_abstractcs_busy$D_IN = 1'bx /* unspecified value */ ;
  endcase
  ...
  always@(WILL_FIRE_RL_rl_unknown_read_start or
	  WILL_FIRE_RL_rl_unknown_write_start or
	  WILL_FIRE_RL_rl_fpr_read_finish or
	  MUX_rg_abstractcs_cmderr$write_1__VAL_3 or
	  WILL_FIRE_RL_rl_fpr_write_finish or
  ...
  case (1'b1)
    ...
    WILL_FIRE_RL_rl_fpr_read_finish:
	rg_abstractcs_cmderr$D_IN = MUX_rg_abstractcs_cmderr$write_1__VAL_3;
    WILL_FIRE_RL_rl_fpr_write_finish:
	rg_abstractcs_cmderr$D_IN = MUX_rg_abstractcs_cmderr$write_1__VAL_3;
    MUX_rg_abstractcs_cmderr$write_1__SEL_5:
  ...
  assign rg_command_access_reg_regno$D_IN =
	     MUX_rg_abstractcs_busy$write_1__SEL_5 ?
	       write_dm_word[12:0] :
	       13'h1000 ;
  ...
  // register rg_command_access_reg_write
  assign rg_command_access_reg_write$D_IN =
	     MUX_rg_abstractcs_busy$write_1__SEL_5 && write_dm_word[16] ;
  ...
  // register rg_data0
  always@(WILL_FIRE_RL_rl_fpr_read_finish or
	  f_hart0_fpr_rsps$D_OUT or
	  MUX_rg_data0$write_1__SEL_2 or
	  write_dm_word or
	  EN_reset or
	  WILL_FIRE_RL_rl_gpr_read_finish or
  ...
  case (1'b1)
    ...
    MUX_rg_data0$write_1__SEL_2: rg_data0$D_IN = write_dm_word;
  ...
  case (1'b1)
    ...
    MUX_rg_data1$write_1__SEL_2: rg_data1$D_IN = write_dm_word;
  ...
  case (1'b1)
    ...
    EN_reset || WILL_FIRE_RL_rl_fpr_write_start ||
    WILL_FIRE_RL_rl_gpr_read_start ||
    WILL_FIRE_RL_rl_gpr_write_start ||
    WILL_FIRE_RL_rl_csr_read_start ||
    WILL_FIRE_RL_rl_csr_write_start:
  ...
  // remaining internal signals
  assign regno__h2725 = { 3'd0, rg_command_access_reg_regno } ;
  assign req_data__h850 = { rg_data1, rg_data0 } ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d38 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1000___d34 &&
	     rg_command_access_reg_regno_read_ULE_0x101F___d36 ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d49 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     !rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1000___d34 &&
	     rg_command_access_reg_regno_read_ULE_0x101F___d36 ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d61 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1020___d57 &&
	     rg_command_access_reg_regno_read_ULE_0x103F___d59 ;
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d72 =
	     rg_abstractcs_busy && rg_start_reg_access &&
	     !rg_command_access_reg_write &&
	     !rg_command_access_reg_regno_read_ULT_0x1020___d57 &&
	     rg_command_access_reg_regno_read_ULE_0x103F___d59 ;
  assign rg_abstractcs_cmderr_read__1_EQ_0_09_AND_write_ETC___d144 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_read__1_EQ_0_09_AND_write_ETC___d176 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] != 3'd3 ;
  assign rg_command_access_reg_regno_read_ULE_0x101F___d36 =
	     rg_command_access_reg_regno <= 13'h101F ;
  assign rg_command_access_reg_regno_read_ULE_0x103F___d59 =
  ...
  assign rg_command_access_reg_regno_read_ULT_0x1000___d34 =
	     rg_command_access_reg_regno < 13'h1000 ;
  assign rg_command_access_reg_regno_read_ULT_0x1020___d57 =
	     rg_command_access_reg_regno < 13'h1020 ;
  assign virt_rg_abstractcs__h720 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd2 } ;
  assign virt_rg_command__h766 =
	     { 15'd17, rg_command_access_reg_write, regno__h2725 } ;
  assign write_dm_addr_EQ_0x16_02_AND_rg_abstractcs_bus_ETC___d119 =
	     write_dm_addr == 7'h16 &&
	     (rg_abstractcs_busy || write_dm_word[10:8] != 3'd0) ||
	     write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr != 7'h04 &&
	     write_dm_addr != 7'h05 ;
  assign write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d151 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     write_dm_word[18] ;
  assign write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d160 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d169 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     !write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_10_AND_NOT_rg_abstractcs_ETC___d223 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] != 3'd3 &&
  ...
  assign x__h1325 = rg_command_access_reg_regno - 13'h1000 ;
  assign x__h1764 = rg_command_access_reg_regno - 13'h1020 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h04 &&
	  write_dm_addr != 7'h05)
	$write("%0d: DM_Abstract_Commands.write: [", v__h4342);
    if (RST_N != `BSV_RESET_VALUE)
