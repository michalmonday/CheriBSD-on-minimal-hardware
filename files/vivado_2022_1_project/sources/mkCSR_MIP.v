...
module mkCSR_MIP(CLK,
  ...
  wire [11 : 0] new_mip__h1070, new_mip__h598;
  wire seip__h632,
       ssip__h1110,
       ssip__h636,
       stip__h634,
  ...
  // value method mv_read
  assign mv_read = { 52'd0, new_mip__h598 } ;

  // actionvalue method mav_write
  assign mav_write = { 52'd0, new_mip__h1070 } ;
  ...
  // register rg_ssip
  always@(EN_reset or
	  EN_mav_write or ssip__h636 or EN_mav_sip_write or ssip__h1110)
  case (1'b1)
    EN_reset: rg_ssip$D_IN = 1'd0;
    EN_mav_write: rg_ssip$D_IN = ssip__h636;
    EN_mav_sip_write: rg_ssip$D_IN = ssip__h1110;
    default: rg_ssip$D_IN = 1'bx /* unspecified value */ ;
  endcase
  assign rg_ssip$EN = EN_mav_write || EN_mav_sip_write || EN_reset ;

  // register rg_stip
  assign rg_stip$D_IN = !EN_reset && stip__h634 ;
  assign rg_stip$EN = EN_mav_write || EN_reset ;

  // register rg_ueip
  always@(EN_reset or
	  EN_mav_write or ueip__h633 or EN_mav_sip_write or ueip__h1109)
  case (1'b1)
    EN_reset: rg_ueip$D_IN = 1'd0;
    EN_mav_write: rg_ueip$D_IN = ueip__h633;
    EN_mav_sip_write: rg_ueip$D_IN = ueip__h1109;
  ...
  // register rg_usip
  always@(EN_reset or
	  EN_mav_write or usip__h637 or EN_mav_sip_write or usip__h1111)
  case (1'b1)
    EN_reset: rg_usip$D_IN = 1'd0;
    EN_mav_write: rg_usip$D_IN = usip__h637;
    EN_mav_sip_write: rg_usip$D_IN = usip__h1111;
    default: rg_usip$D_IN = 1'bx /* unspecified value */ ;
  endcase
  assign rg_usip$EN = EN_mav_write || EN_mav_sip_write || EN_reset ;

  // register rg_utip
  assign rg_utip$D_IN = !EN_reset && utip__h635 ;
  assign rg_utip$EN = EN_mav_write || EN_reset ;

  // remaining internal signals
  assign new_mip__h1070 =
	     { rg_meip,
	       1'b0,
	       seip__h632,
	       ueip__h633,
  ...
  assign new_mip__h598 =
	     { rg_meip,
	       ...
	       rg_ssip,
	       rg_usip } ;
  assign seip__h632 = mav_write_misa[18] && mav_write_wordxl[9] ;
  assign ssip__h1110 = mav_sip_write_misa[18] && mav_sip_write_wordxl[1] ;
  assign ssip__h636 = mav_write_misa[18] && mav_write_wordxl[1] ;
  assign stip__h634 = mav_write_misa[18] && mav_write_wordxl[5] ;
  assign ueip__h1109 = mav_sip_write_misa[13] && mav_sip_write_wordxl[8] ;
  assign ueip__h633 = mav_write_misa[13] && mav_write_wordxl[8] ;
  assign usip__h1111 = mav_sip_write_misa[13] && mav_sip_write_wordxl[0] ;
  assign usip__h637 = mav_write_misa[13] && mav_write_wordxl[0] ;
  assign utip__h635 = mav_write_misa[13] && mav_write_wordxl[4] ;
