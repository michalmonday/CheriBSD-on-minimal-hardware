...
module mkDM_Run_Control(CLK,
  ...
  always@(av_read_dm_addr or
	  rg_verbosity or
	  virt_rg_dmcontrol__h900 or virt_rg_dmstatus__h798 or haltsum__h708)
  begin
    case (av_read_dm_addr)
      7'h10: av_read = virt_rg_dmcontrol__h900;
  ...
  assign virt_rg_dmcontrol__h900 =
	     { 2'b0,
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_7_AND_rg_dmcontro_ETC___d113)
	$display("%0d: %m.dmcontrol_write: hart0 resume request", v__h3145);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_7_AND_rg_dmcontro_ETC___d122)
	begin
    ...
    v__h3194 = v__h3200 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_7_AND_rg_dmcontro_ETC___d122)
	$display("%0d: %m.dmcontrol_write: hart0 halt request", v__h3194);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && !write_dm_word[0])
	begin
	  v__h2180 = $stime;
