...
module mkDM_CSR_Tap(CLK,
  ...
  // submodule f_req_in
  FIFO2 #(.width(32'd77), .guarded(1'd1)) f_req_in(.RST(RST_N),
						   .CLK(CLK),
						   .D_IN(f_req_in$D_IN),
						   .ENQ(f_req_in$ENQ),
						   .DEQ(f_req_in$DEQ),
  ...
  // submodule f_req_out
  FIFO2 #(.width(32'd77), .guarded(1'd1)) f_req_out(.RST(RST_N),
						    .CLK(CLK),
						    .D_IN(f_req_out$D_IN),
						    .ENQ(f_req_out$ENQ),
						    .DEQ(f_req_out$DEQ),
  ...
  // submodule f_rsp
  FIFO2 #(.width(32'd65), .guarded(1'd1)) f_rsp(.RST(RST_N),
						.CLK(CLK),
						.D_IN(f_rsp$D_IN),
						.ENQ(f_rsp$ENQ),
						.DEQ(f_rsp$DEQ),
  ...
  // remaining internal signals
  assign x__h686 = { 52'd0, f_req_in$D_OUT[75:64] } ;
