...
module mkTLB(CLK,
  ...
  reg [2 : 0] tlb0_entries_clearIx;
  wire [2 : 0] tlb0_entries_clearIx$D_IN;
  ...
  wire [168 : 0] tlb0_entries_mem_0_bram$DIA,
		 tlb0_entries_mem_0_bram$DIB,
		 tlb0_entries_mem_0_bram$DOA;
  wire [2 : 0] tlb0_entries_mem_0_bram$ADDRA, tlb0_entries_mem_0_bram$ADDRB;
  ...
  wire [168 : 0] tlb0_entries_mem_1_bram$DIA,
		 tlb0_entries_mem_1_bram$DIB,
		 tlb0_entries_mem_1_bram$DOA;
  wire [2 : 0] tlb0_entries_mem_1_bram$ADDRA, tlb0_entries_mem_1_bram$ADDRB;
  ...
  wire [24 : 0] tlb0_entries_updateKeys_0_bram$DIA,
		tlb0_entries_updateKeys_0_bram$DIB,
		tlb0_entries_updateKeys_0_bram$DOA;
  wire [2 : 0] tlb0_entries_updateKeys_0_bram$ADDRA,
  ...
  wire [24 : 0] tlb0_entries_updateKeys_1_bram$DIA,
		tlb0_entries_updateKeys_1_bram$DIB,
		tlb0_entries_updateKeys_1_bram$DOA;
  wire [2 : 0] tlb0_entries_updateKeys_1_bram$ADDRA,
  ...
  wire [160 : 0] MUX_tlb1_entries_mem_0$upd_2__VAL_1,
		 MUX_tlb1_entries_mem_0$upd_2__VAL_2;
  wire [151 : 0] MUX_tlb2_entries_mem_0$upd_2__VAL_1,
		 MUX_tlb2_entries_mem_0$upd_2__VAL_2;
  ...
  reg [63 : 0] _theResult___fst__h4612;
  ...
  wire [63 : 0] IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d123,
		IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d162,
		_theResult_____3_fst__h5890,
		_theResult_____4_fst__h5846,
		pa___1__h5935,
		pa___1__h5984,
		pa___1__h6052,
		pte___1__h4609,
		pte___1__h4611,
		result0_pte__h4952,
		result0_pte_pa__h4954,
		x__h4971,
		x__h4978,
		x__h5931,
		x__h6190;
  wire [55 : 0] x__h5938, x__h5987, x__h6055;
  wire [15 : 0] IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d116;
  wire [5 : 0] exc_code___1__h6148, result_exc_code__h4567;
  wire [2 : 0] v__h3816;
  ...
  wire IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d119,
       ...
       tlb0_entries_updateKeys_1_bram_a_read__6_BIT_2_ETC___d54,
       tlb0_entries_updateKeys_1_bram_a_read__6_BIT_2_ETC___d57,
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd3),
	  .DATA_WIDTH(32'd169),
	  .MEMSIZE(4'd8)) tlb0_entries_mem_0_bram(.CLKA(CLK),
						  .CLKB(CLK),
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd3),
	  .DATA_WIDTH(32'd169),
	  .MEMSIZE(4'd8)) tlb0_entries_mem_1_bram(.CLKA(CLK),
						  .CLKB(CLK),
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd3),
	  .DATA_WIDTH(32'd25),
	  .MEMSIZE(4'd8)) tlb0_entries_updateKeys_0_bram(.CLKA(CLK),
							 .CLKB(CLK),
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd3),
	  .DATA_WIDTH(32'd25),
	  .MEMSIZE(4'd8)) tlb0_entries_updateKeys_1_bram(.CLKA(CLK),
							 .CLKB(CLK),
  ...
  assign MUX_tlb1_entries_mem_0$upd_2__VAL_1 =
	     { 1'd1,
	       ...
	       ma_insert_pte,
	       ma_insert_pte_pa } ;
  assign MUX_tlb1_entries_mem_0$upd_2__VAL_2 =
	     { 1'd0,
	       160'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } ;
  assign MUX_tlb2_entries_mem_0$upd_2__VAL_1 =
	     { 1'd1,
	       ...
	       ma_insert_pte,
	       ma_insert_pte_pa } ;
  assign MUX_tlb2_entries_mem_0$upd_2__VAL_2 =
	     { 1'd0,
  ...
  // register tlb0_entries_clearIx
  assign tlb0_entries_clearIx$D_IN = tlb0_entries_clearIx + 3'd1 ;
  ...
  assign tlb0_entries_clearReqQ$DEQ =
	     tlb0_entries_clearReqQ$EMPTY_N && tlb0_entries_clearIx == 3'd7 ;
  assign tlb0_entries_clearReqQ$CLR = 1'b0 ;

  // submodule tlb0_entries_mem_0_bram
  assign tlb0_entries_mem_0_bram$ADDRA =
	     EN_mv_vm_put_va ?
	       tlb0_entries_lookupWire$wget[2:0] :
	       tlb0_entries_lookupReg[2:0] ;
  assign tlb0_entries_mem_0_bram$ADDRB =
	     tlb0_entries_clearReqQ$EMPTY_N ?
	       tlb0_entries_clearIx :
	       tlb0_entries_updateReg[146:144] ;
  assign tlb0_entries_mem_0_bram$DIA =
	     169'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  ;
  assign tlb0_entries_mem_0_bram$DIB =
	     tlb0_entries_clearReqQ$EMPTY_N ?
	       { 1'd0,
		 168'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */  } :
	       { 1'd1,
		 tlb0_entries_updateReg[170:147],
  ...
  // remaining internal signals
  assign IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d116 =
	     (tlb0_entries_mem_1_bram$DOA[168] &&
	      tlb0_entries_lookupReg[26:3] ==
	      tlb0_entries_mem_1_bram$DOA[167:144]) ?
	       tlb0_entries_mem_1_bram$DOA[143:128] :
	       tlb0_entries_mem_0_bram$DOA[143:128] ;
  assign IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d123 =
	     (tlb0_entries_mem_1_bram$DOA[168] &&
	      tlb0_entries_lookupReg[26:3] ==
	      tlb0_entries_mem_1_bram$DOA[167:144]) ?
	       tlb0_entries_mem_1_bram$DOA[127:64] :
	       tlb0_entries_mem_0_bram$DOA[127:64] ;
  assign IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d162 =
	     (tlb0_entries_mem_1_bram$DOA[168] &&
	      tlb0_entries_lookupReg[26:3] ==
	      tlb0_entries_mem_1_bram$DOA[167:144]) ?
  ...
  assign _theResult_____3_fst__h5890 =
	     { pte___1__h4609[63:8], 1'd1, pte___1__h4609[6:0] } ;
  assign _theResult_____4_fst__h5846 =
  ...
  assign _theResult____h3129 =
	     tlb0_entries_updateKeys_1_bram$DOA[24] &&
	     tlb0_entries_updateReg[170:147] ==
	     tlb0_entries_updateKeys_1_bram$DOA[23:0] ||
	     (!tlb0_entries_updateKeys_0_bram$DOA[24] ||
	      tlb0_entries_updateReg[170:147] !=
	      tlb0_entries_updateKeys_0_bram$DOA[23:0]) &&
  ...
  assign mv_vm_get_xlate_priv_ULE_0b1_1_AND_mv_vm_get_x_ETC___d274 =
	     mv_vm_get_xlate_priv_ULE_0b1___d91 &&
	     mv_vm_get_xlate_satp[63:60] == 4'd8 &&
	     (!pte___1__h4609[7] && !mv_vm_get_xlate_read_not_write ||
	      !IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d175[72]) ;
  assign mv_vm_get_xlate_priv_ULE_0b1___d91 = mv_vm_get_xlate_priv <= 2'b01 ;
  assign pa___1__h5935 = { 8'd0, x__h5938 } ;
  assign pa___1__h5984 = { 8'd0, x__h5987 } ;
  assign pa___1__h6052 = { 8'd0, x__h6055 } ;
  assign pte___1__h4609 =
	     IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d175[72] ?
	       IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d175[129:66] :
	       _theResult_____4_fst__h5846 ;
  assign pte___1__h4611 =
	     (!pte___1__h4609[7] && !mv_vm_get_xlate_read_not_write) ?
	       _theResult_____3_fst__h5890 :
	       pte___1__h4609 ;
  assign result0_pte__h4952 =
	     tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d99 ?
	       tlb0_entries_updateReg[127:64] :
	       IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d123 ;
  assign result0_pte_pa__h4954 =
	     tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d99 ?
	       tlb0_entries_updateReg[63:0] :
	       IF_tlb0_entries_mem_1_bram_a_read__00_BIT_168__ETC___d162 ;
  assign result_exc_code__h4567 =
	     mv_vm_get_xlate_priv_EQ_0b0_57_AND_NOT_IF_tlb0_ETC___d263 ?
	       exc_code___1__h6148 :
	       6'd27 ;
  assign tlb0_entries_updateKeys_1_bram_a_read__6_BIT_2_ETC___d54 =
	     _theResult____h3129 == 1'd0 && !tlb0_entries_clearReqQ$EMPTY_N &&
	     tlb0_entries_updateReg[171] &&
	     tlb0_entries_updateRegFresh ;
  assign tlb0_entries_updateKeys_1_bram_a_read__6_BIT_2_ETC___d57 =
  ...
  assign tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d127 =
	     (tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d99 ||
	      ...
	      (tlb0_entries_mem_1_bram$DOA[168] &&
	       tlb0_entries_lookupReg[26:3] ==
	       tlb0_entries_mem_1_bram$DOA[167:144] ||
	       tlb0_entries_mem_0_bram$DOA[168] &&
	       tlb0_entries_lookupReg[26:3] ==
	       tlb0_entries_mem_0_bram$DOA[167:144])) &&
	     (IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d119 ||
	      result0_pte__h4952[5]) ;
  assign tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d99 =
	     tlb0_entries_updateReg[171] &&
	     tlb0_entries_lookupReg[2:0] == tlb0_entries_updateReg[146:144] &&
	     tlb0_entries_lookupReg[26:3] == tlb0_entries_updateReg[170:147] ;
  ...
  assign v__h3816 =
	     tlb0_entries_updateWire$whas ?
	       tlb0_entries_updateWire$wget[146:144] :
	       tlb0_entries_updateReg[146:144] ;
  assign x__h4971 =
	     tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_en_ETC___d127 ?
	       result0_pte__h4952 :
  ...
  always@(IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d175 or
	  rg_va or pa___1__h5935 or pa___1__h5984 or pa___1__h6052)
  begin
    case (IF_tlb0_entries_updateReg_8_BIT_171_9_AND_tlb0_ETC___d175[65:64])
      2'd0: _theResult___fst__h4612 = pa___1__h5935;
      2'd1: _theResult___fst__h4612 = pa___1__h5984;
      2'd2: _theResult___fst__h4612 = pa___1__h6052;
      2'd3: _theResult___fst__h4612 = rg_va;
    endcase
  end
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        tlb0_entries_clearIx <= `BSV_ASSIGNMENT_DELAY 3'd0;
  ...
  begin
	...
	$display("MapLookup - index: %x, key: %x",
		 mv_vm_put_va_full_va[14:12],
		 mv_vm_put_va_full_va[38:15]);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_flush && NOT_verbosity_ULE_1_4___d85)
	$display("%0d: %m.rl_flush", v__h4388);
    if (RST_N != `BSV_RESET_VALUE)
