...
#
# Generated by export_simulation on Thu Nov 03 14:44:26 PDT 2022
#
################################################################################
...
'-reset_run' switch to the './p2_ddr3.sh' script.

./p2_ddr3.sh -reset_run
...
./p2_ddr3.sh -noclean_files

For more information on the script, please type './p2_ddr3.sh -help'.
